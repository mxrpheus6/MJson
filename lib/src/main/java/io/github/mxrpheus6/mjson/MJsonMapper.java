...
public class MJsonMapper {
     ...
     * This method parses the given JSON string into a map of key-value pairs and
     * recursively constructs an object of the specified class by setting its fields
     * using reflection. It supports deserialization of primitive types, strings,
     * collections (List, Set, Map), arrays, and date/time types such as
     * {@link LocalDate}, {@link LocalDateTime}, {@link OffsetDateTime},
     * {@link ZonedDateTime}, and {@link UUID}.
     *
     ...
     * @throws Exception if an error occurs during deserialization, such as
     *                   reflection errors or unsupported types.
     * @throws IllegalArgumentException if the JSON string cannot be parsed into
     *                                  an appropriate type for a field in the class.
     */
